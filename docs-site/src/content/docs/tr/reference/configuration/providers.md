...
| --- | --- | --- | --- |
| `anthropicAccountPool.enabled?` | `boolean` | `false` | Proaktif yapışkan bağlılığı ve yeni oturum seçimini etkinleştirin. İki veya daha fazla uygun hesap varsa tepkisel 429 bekletme ve geçişi `false` iken de çalışır. |
