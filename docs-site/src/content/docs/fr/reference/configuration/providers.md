...
| --- | --- | --- | --- |
| `anthropicAccountPool.enabled?` | `boolean` | `false` | Active l’affinité proactive persistante et la sélection des nouvelles sessions. Avec au moins deux comptes éligibles, la récupération réactive après 429 reste active même avec `false`. |
